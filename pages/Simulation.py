...
def simulate_reaction(a, b, c, d, delta_H,
                      ...
                      B_phase1, B_phase2, B_phase3, B_phase4, B_phase5,
                      C_phase1, C_phase2, C_phase3, C_phase4, C_phase5,
                      D_phase1, D_phase2, D_phase3, D_phase4, D_phase5):
    k1_base = 0.02
    k2_base = 0.01
    k1_current = k1_base
    k2_current = k2_base
    ...
    # 5 phases: "Base" plus 4 boundaries.
    ...
    for i, sol in enumerate(sols):
        if a != 0 and ((i == 0 and A_phase1) or (i == 1 and A_phase2) or (i == 2 and A_phase3) or (i == 3 and A_phase4) or (i == 4 and A_phase5)):
            plt.plot(t_phases[i], sol[:, 0], label=f'A {phases_labels[i]}', color='blue', linewidth=2)
        if b != 0 and ((i == 0 and B_phase1) or (i == 1 and B_phase2) or (i == 2 and B_phase3) or (i == 3 and B_phase4) or (i == 4 and B_phase5)):
            plt.plot(t_phases[i], sol[:, 1], label=f'B {phases_labels[i]}', color='red', linewidth=2)
        if c != 0 and ((i == 0 and C_phase1) or (i == 1 and C_phase2) or (i == 2 and C_phase3) or (i == 3 and C_phase4) or (i == 4 and C_phase5)):
            plt.plot(t_phases[i], sol[:, 2], label=f'C {phases_labels[i]}', color='green', linewidth=2)
        if d != 0 and ((i == 0 and D_phase1) or (i == 1 and D_phase2) or (i == 2 and D_phase3) or (i == 3 and D_phase4) or (i == 4 and D_phase5)):
            plt.plot(t_phases[i], sol[:, 3], label=f'D {phases_labels[i]}', color='purple', linewidth=2)
    
    # Draw vertical connecting lines at each phase boundary.
    for i in range(len(phases)-1):
        t_boundary = t_phases[i][-1]
        if a != 0 and ((i == 0 and A_phase1 and A_phase2) or (i == 1 and A_phase2 and A_phase3) or (i == 2 and A_phase3 and A_phase4) or (i == 3 and A_phase4 and A_phase5)):
            draw_connection(t_boundary, sols[i][-1, 0], sols[i+1][0, 0], 'blue')
        if b != 0 and ((i == 0 and B_phase1 and B_phase2) or (i == 1 and B_phase2 and B_phase3) or (i == 2 and B_phase3 and B_phase4) or (i == 3 and B_phase4 and B_phase5)):
            draw_connection(t_boundary, sols[i][-1, 1], sols[i+1][0, 1], 'red')
        if c != 0 and ((i == 0 and C_phase1 and C_phase2) or (i == 1 and C_phase2 and C_phase3) or (i == 2 and C_phase3 and C_phase4) or (i == 3 and C_phase4 and C_phase5)):
            draw_connection(t_boundary, sols[i][-1, 2], sols[i+1][0, 2], 'green')
        if d != 0 and ((i == 0 and D_phase1 and D_phase2) or (i == 1 and D_phase2 and D_phase3) or (i == 2 and D_phase3 and D_phase4) or (i == 3 and D_phase4 and D_phase5)):
...
if 'selected_reaction' not in st.session_state:
    ...
    A_phase5 = st.sidebar.checkbox("A Phase 5", value=True)
    ...
    B_phase5 = st.sidebar.checkbox("B Phase 5", value=True)
    ...
    C_phase5 = st.sidebar.checkbox("C Phase 5", value=True)
    ...
    D_phase5 = st.sidebar.checkbox("D Phase 5", value=True)
